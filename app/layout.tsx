    ...
    return (
        ...
        <div className={`h-screen flex flex-col`}>
            <div className={"flex flex-row justify-between py-3 px-1 items-center"}>
                <Wordmark/>
                <div className="w-[40%] portrait:hidden"><Suspense><SearchInput isNavBar={true}/></Suspense>
                </div>
                <BookmarksPageButton/>
            </div>
            <div className="landscape:hidden mx-4"><Suspense><SearchInput isNavBar={true}/></Suspense>
            </div>
